namespace BlackGoldAncientSword.Modules.UI.ClosePrompt.Views
{
    public partial class ClosePromptPage
    {
        ...
        private void DismissOverlay()
        {
            ...
            var rm = BlackGoldAncientSword.Framework.Core.Bases.PrismApplicationBase.ContainerProvider
                .Resolve<Prism.Regions.IRegionManager>();
            var region = rm.Regions[BlackGoldAncientSword.Framework.Core.Consts.GlobalConstant.ClosePromptRegion];
            region.RemoveAll();
        }
    }
}